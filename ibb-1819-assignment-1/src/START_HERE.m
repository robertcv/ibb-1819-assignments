...
% 		struct('path', 'awet_lpq',     'name', 'LPQ', 'distance', 'chi', 'bulk_postprocess', false, 'parameters', struct())
        struct('path', 'awet_rilpq',   'name', 'RILPQ','distance', 'chi', 'bulk_postprocess', false, 'parameters', struct('w', [9], 'a', [4]))    
%       struct('path', 'awet_rilpq',   'name', 'RILPQ','distance', 'chi', 'bulk_postprocess', false, 'parameters', struct('w', [9, 15], 'a', [4, 8, 12]))
...
% 		struct('path', 'awet_gabor',   'name', 'Gabor','distance', 'cosine', 'bulk_postprocess', false, 'parameters', struct())
 		struct('path', 'robi',   'name', 'Robi','distance', 'chi', 'bulk_postprocess', false, 'parameters', struct('s', [24]))
];
% extractors = [];
